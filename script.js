...
//Function para remover o item do carrinho
...
checkoutBtn.addEventListener("click",function(){
    ...
    const isOpen = checkRestaurantOpen();
        if(!isOpen){
            Toastify({
                text: "Ops o restaurante está fechado no momento! Horário de funcionamento: 18:00 ás 22:00hrs.",
                duration: 3000,
                close: true,
